      ...
      <title>Signup</title>
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <p className="text-gray-700 text-lg">
                Join our blood donation campaign and become a real-life hero.
                Your one signup can help save multiple lives.
            </p>
            ...
            <div className="card-body space-y-4">
                ...
                <div>
                    <label className="label font-medium text-gray-700">Profile Image</label>
                    <input
                    name="imageurl"
                    type="file"
